...
- `cds add data-privacy` now adds the HDI default role with the schema role for accessing DPP views included. Previously it was only generated by `cds build`.
