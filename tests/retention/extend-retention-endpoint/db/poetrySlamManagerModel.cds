...
entity PoetrySlams : cuid, managed {
  ...
  // DPI
  PoetrySlamOrganizer : Association to one PoetrySlamOrganizers @title: 'PoetrySlamOrganizers';
}
...
// Additional DPI Enhancements
entity PoetrySlamOrganizers : managed {
  key title       : String;
      description : String;
}

// entity VisitorsDataControllerMapping : managed {
//   key ID               : String;
//   key datacontroller   : Association to one DataControllers @title: 'DataController';
// }
