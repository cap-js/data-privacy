...
function buildOrganizationAttribute(o) {
  ...
  const existingOrgAttributes = Object.keys(o.model.definitions).filter(n => n.startsWith(`sap.ilm.RetentionService.valueHelp_orgAttribute`)).map(def => o.model.definitions[def]);
