 ...
 */
function buildMixinFields({ entity, fullName, backLinkName, parentName, compName, comp, o }) {
  const mixin = {};
  const excluding = [];
...
function createNewComposedEntity(
  ...
  if (o.assignInformationAnnotations) {
    ...
    Object.assign(newEntity, assignInformationAnnotations(newEntity, [newDsFields.eob]));
  }
  if (!o.exposeEntities) {
