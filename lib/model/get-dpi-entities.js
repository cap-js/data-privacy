...
function getDPIentities(model, drmSrv) {
    ...
    function buildOrganizationAttribute(entity) {
      ...
      } else if (entity.elements[entity.elements[orgAttributeName]._foreignKey4]?.type === 'cds.Association' || entity.elements[entity.elements[orgAttributeName]._foreignKey4]?.type.type === 'cds.Composition') { //Case of missing ValueList annotation -> But its a relation
