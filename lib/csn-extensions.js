  ...
  get() {
    return {
      ...
      dataSubjectsForRole: function dataSubjectsForRole(role) {
        ...
        for (const dataSubject in this._dpi.dataSubjects) {
          if (this._dpi.dataSubjects[dataSubject]['@PersonalData.DataSubjectRole'] === role || this._dpi.dataSubjects[dataSubject]['@PersonalData.DataSubjectRole']?.['=']) {
            resultWithRole[dataSubject] = this._dpi.dataSubjects[dataSubject];
          }
        }
      ...
      get organizationAttributes() {
        return this._dpi.iLMObjects
