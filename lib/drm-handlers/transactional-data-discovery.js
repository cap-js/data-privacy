    ...
    for(const [eName, entity] of Object.entries(srv.entities)) {
      if (/* !entity._service && !entity.projection && !entity.select &&  */entity['@PersonalData.EntitySemantics'] === 'Other' && entity['@cds.drm.rootEntity']) {
        ...
        const legalGround = {
          ...
          dataSubjectOrganizationAttributeValuesEndPoint: `${servicePath}/dataSubjectOrganizationAttributeValues`,
          dataSubjectLastRetentionStartDatesEndPoint: `${servicePath}/dataSubjectLatestRetentionStartDates`,
          ...
          dataSubjectLegalGroundDeletionEndPoint: `${servicePath}/dataSubjectILMObjectInstanceBlocking`,
          dataSubjectsLegalGroundDestroyingEndPoint: `${servicePath}/dataSubjectsILMObjectInstancesDestroying`,
